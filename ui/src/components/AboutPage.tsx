        ...
        <div style={styles.content}>
          ...
          <section style={styles.section}>
            ...
            <div style={styles.quote}>
              "Elon personally interviewed the first 3,000 SpaceX hires. He
              finds exceptional people in weird corners of the internet —
              engineers with 800 followers doing incredible work that LinkedIn
              will never surface."
            </div>
            <p style={styles.text}>
              Traditional recruiting optimizes for{" "}
              <strong>polish over substance</strong>. Resume keywords, LinkedIn
              endorsements, and credential signaling miss the builders who are
              too busy shipping to self-promote.
            </p>
          </section>
          ...
          <section style={styles.section}>
            ...
            <p style={styles.text}>
              We reverse-engineer{" "}
              <strong>Elon's implicit taste function</strong> by analyzing who
              xAI engineers interact with on X. Likes, retweets, and substantive
              replies reveal who the team respects — before they're famous.
            </p>
            ...
            <div style={styles.pipeline}>
              <div style={styles.pipelineStep}>
                ...
                <div style={styles.stepContent}>
                  ...
                  <p style={styles.stepDesc}>
                    Start with seed accounts. Expand via likes, retweets,
                    replies. Build interaction edges with weighted signals.
                  </p>
                </div>
              </div>
              ...
              <div style={styles.pipelineStep}>
                ...
                <div style={styles.stepContent}>
                  ...
                  <p style={styles.stepDesc}>
                    <code>grok-4-1-fast</code> screens bios for technical
                    relevance. Filters 16k → 500 candidates in minutes.
                  </p>
                </div>
              </div>
              ...
              <div style={styles.pipelineStep}>
                ...
                <div style={styles.stepContent}>
                  ...
                  <p style={styles.stepDesc}>
                    Personalized PageRank with seeds as the personalization
                    vector.
                    <strong> Underratedness = PPR / log(followers)</strong>{" "}
                    finds hidden gems.
                  </p>
                </div>
              </div>
              ...
              <div style={styles.pipelineStep}>
                ...
                <div style={styles.stepContent}>
                  ...
                  <p style={styles.stepDesc}>
                    <code>grok-4-1-reasoning</code> + xAI Search Tools analyzes
                    GitHub, LinkedIn, and X posts. Scores on 5-criterion rubric.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section style={styles.section}>
            ...
            <p style={styles.text}>
              Each candidate is scored 0-100 based on what Musk looks for in
              interviews:
            </p>
            ...
            <div style={styles.whyGrid}>
              <div style={styles.whyItem}>
                ...
                <p style={styles.whyDesc}>
                  A like from an xAI engineer means more than 10k LinkedIn
                  connections
                </p>
              </div>
              <div style={styles.whyItem}>
                ...
                <p style={styles.whyDesc}>
                  Optimizes for substance over polish — finds builders, not
                  self-promoters
                </p>
              </div>
              <div style={styles.whyItem}>
                ...
                <p style={styles.whyDesc}>
                  Uses xAI's own models + Search Tools for deep candidate
                  analysis
                </p>
              </div>
              <div style={styles.whyItem}>
                ...
                <p style={styles.whyDesc}>
                  Every score comes with evidence and reasoning — not a black
                  box
                </p>
              </div>
            </div>
          ...
          <div style={styles.footer}>
            <p>Built for the xAI Hackathon 2025</p>
          </div>
        </div>
      </div>
    </div>
